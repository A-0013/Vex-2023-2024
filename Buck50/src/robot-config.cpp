...
motor LiftMotorA = motor(PORT15, ratio6_1, false);
motor LiftMotorB = motor(PORT10, ratio6_1, true);
...
motor LDrive_GroupMotorA = motor(PORT11, ratio18_1, true);
motor LDrive_GroupMotorB = motor(PORT13, ratio18_1, true);
motor_group LDrive_Group = motor_group(LDrive_GroupMotorA, LDrive_GroupMotorB);
motor RDrive_GroupMotorA = motor(PORT12, ratio18_1, true);
motor RDrive_GroupMotorB = motor(PORT14, ratio18_1, true);
