...
void driveToPositionX(double x) {
  ...
  TurnautonomousPIDMovement(pidTurn);
  ...
  DriveautonomousPIDMovement(pidDrive);
...
void circle(double radius, double degree, bool dir)//using time
{
    ...
    setDrivetrainSpeed(left_Speed, right_Speed); 
...
void autonomous(void) {
  ...
  DriveautonomousPIDMovement(412);
  TurnautonomousPIDMovement(324);
