...
void DriveautonomousPIDMovement(int target, bool direction) {
    // Main control loop
...
// Function for autonomous PID movement
void TurnautonomousPIDMovement(int target, bool direction) {
    // Main control loop
...
void autonomous(void) {
  ...
  // ..........................................................................
    ...
    //Farside
  /*
  DriveautonomousPIDMovement(859, true);
  TurnautonomousPIDMovement(162, true);
  DriveautonomousPIDMovement(25, true);
  Intake.spinFor(forward, 2000, degrees);
  DriveautonomousPIDMovement(90, true);
  DriveautonomousPIDMovement(50, false);
  TurnautonomousPIDMovement(324, true);
  DriveautonomousPIDMovement(515, true);
  Intake.spinFor(reverse, 2000, degrees);  
  TurnautonomousPIDMovement(486, false);
  DriveautonomousPIDMovement(945, true);
  TurnautonomousPIDMovement(486, true);
  DriveautonomousPIDMovement(463, true);
  Intake.spinFor(forward, 2000, degrees);                                                                                                                                                                                                                                                               
  DriveautonomousPIDMovement(51, true);
*/
 //Close Side
 
  DriveautonomousPIDMovement(721, true);
  TurnautonomousPIDMovement(486, true);
  Intake.spin(forward, 95, pct);
  wait(1,sec);
  DriveautonomousPIDMovement(150, true);
  TurnautonomousPIDMovement(162, false);
  Wings1.set(true);
  Wings2.set(true);
  DriveautonomousPIDMovement(618, true);
  Intake.spinFor(forward, 2000, degrees);
  //wait(1,sec);
  //Intake.stop();
  Wings1.set(false);
